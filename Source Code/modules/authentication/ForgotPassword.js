...
const  ForgotPassword=({navigation})=> {
  ...
  const handleOTP = () => {
    if(email){
      ...
      setErrorMessage('Please provide Email or Phone Number to get OTP!');
    }
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <MyButton title="Confirm" onPress={handleConfirmButton} backgroundColor='white' textColor={Colors.primary}/>
    </View>
